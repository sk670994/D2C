...
import ZwirkImmersiveScene from "@/components/zwirk/ZwirkImmersiveScene";
...
export default function ZwirkPage() {
  ...
  return (
    <main className="main zwirk-page zwirk-immersive">

      <div className="zwirk-immersive-strip">
        <ZwirkImmersiveScene />
      </div>      <header className="zwirk-hero">
        <div>
          <p className="eyebrow">
