-- Brand Vault Pro core configuration and saved intelligence.
-- User-facing tables are RLS protected. Public/global AdSpy data remains in the
-- existing service-only intelligence layer.
