...
/*
 * Ad creatives are provider-hosted and their image hosts are dynamic.
 * Plain <img> is intentionally used here so the creative viewer does not
 * require a hard-coded Next Image remote-host allow-list.
 */
            ...
            >
              ...
              <div>
                ...
                <strong>
                  {ad.productPrice !=
                  null
                    ? `${ad.currency ?? ""} ${ad.productPrice}`.trim()
                    : "—"}
                </strong>
              </div>
